...
from views import update_animal, update_customer, update_employee, update_location, get_animals_by_status
from views import get_customers_by_email, get_animals_by_location_id, get_employees_by_location_id
